...
Item {
    ...
    function dbg(str, code ="") {
        console.log( String("[ItemMonth.qml]#%1 %2").arg(code).arg(str));
    }
    ...
    Action {
        id: loadCostAction
        text: qsTr("Cost by month")
        onTriggered: {
            root.title = String("%1, %2").arg(text).arg(vw.year)
            vw.repo = "cost"
            // vw.load()
        }
    }
    ...
    Component {
        ...
        FocusScope {
            ...
            height: 28;
            function cellText(v) { return v === 0 ? "" : v.toLocaleString(Qt.locale(), "f", 0);/*v.toFixed(0);*/}
            Rectangle{
                anchors{fill:parent}
                clip: true
                Row{
                   ...
                   Row{
                                      ...
                                      Text{
                                          ...
                                          font.bold: true
                                          // text: Number(total).toLocaleString(Qt.locale(), "f", 0)
                   ...
                   Row{
                                      ...
                                      spacing: 1
                                      property real cellWidth: (width - 11 * spacing)/12
                                      // Repeater {
                                      //        model: 11
                                      //        Text {
                                      ...
                                      Text{
                                          width: parent.cellWidth
                                          horizontalAlignment: Text.AlignRight
                                          text: root.cellText(mon_01)
                                          clip: true
                                      }
                                      Text{
                                                         width: parent.cellWidth
                                          horizontalAlignment: Text.AlignRight
                                          text: root.cellText(mon_02)
                                          clip: true
                                      }
                                      Text{
                                                         width: parent.cellWidth
                                          horizontalAlignment: Text.AlignRight
                                          text: root.cellText(mon_03)
                                          clip: true
                                      }
                                      Text{
                                                         width: parent.cellWidth
                                          horizontalAlignment: Text.AlignRight
                                          text: root.cellText(mon_04)
                                          clip: true
                                      }
                                      Text{
                                          width: parent.cellWidth
                                          horizontalAlignment: Text.AlignRight
                                          text: root.cellText(mon_05)
                                          clip: true
                                      }
                                      Text{
                                          width: parent.cellWidth
                                          horizontalAlignment: Text.AlignRight
                                          text: root.cellText(mon_06)
                                          clip: true
                                      }
                                      Text{
                                          width: parent.cellWidth
                                          horizontalAlignment: Text.AlignRight
                                          text: root.cellText(mon_07)
                                          clip: true
                                      }
                                      Text{
                                          width: parent.cellWidth
                                          horizontalAlignment: Text.AlignRight
                                          text: root.cellText(mon_08)
                                          clip: true
                                      }
                                      Text{
                                          width: parent.cellWidth
                                          horizontalAlignment: Text.AlignRight
                                          text: root.cellText(mon_09)
                                          clip: true
                                      }
                                      Text{
                                                         width: parent.cellWidth
                                          horizontalAlignment: Text.AlignRight
                                          text: root.cellText(mon_10)
                                          clip: true
                                      }
                                      Text{
                                                         width: parent.cellWidth
                                          horizontalAlignment: Text.AlignRight
                                          text: root.cellText(mon_11)
                                          clip: true
                                      }
                                      Text{
                                                         width: parent.cellWidth
                                          horizontalAlignment: Text.AlignRight
                                          text: root.cellText(mon_12)
                                          clip: true
                                      }
                   }
                                      ...
                                      Row{
                                                         ...
                                                         Repeater {
                                                                ...
                                                                Label {
                                                                    width: parent.cellWidth
                                                                    horizontalAlignment: Text.AlignHCenter
                                                                    text: String("%1%2").arg(modelData < 9 ? "0" : "").arg(modelData+1)
                                                                }
                                                         }
                                      }
                   }
